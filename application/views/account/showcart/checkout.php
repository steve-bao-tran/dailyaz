											    ...
											    <div class="panel panel-default">
											      	<div class="panel-heading">
											      		<a data-toggle="collapse" data-parent="#accordion" href="#collapse1" style="text-decoration: none;">
												        	<h4 class="panel-title" style="font-weight: bold;">Thành Viên</h4>
												    	</a>
											      	</div>
											      	<div id="collapse1" class="panel-collapse collapse in">
											        	<div class="panel-body">
															
															<form action="<?php echo base_url() ?>checkout/login" name="frmSignin" id="frmSignin" method="post">
																<div class="form-group">
																    <input type="text" class="input-form-custom form-control" name="username" id="username" placeholder="Tên đăng nhập / Email" required="">
																</div>

																<div class="form-group">
																    <input type="password" class="input-form-custom form-control" name="password" id="password" placeholder="Mật khẩu" required="">
																</div>
																
																<div class="form-group">
																	<button type="submit" class="btn btn-primary">Đăng nhập & Tiếp tục</button><span class="pull-right"><h6><a href="<?php echo base_url() ?>tai-khoan/quen-mat-khau">Quên mật khẩu?</a></h6></span>
																</div>
											    ...
											    <div class="panel panel-default">
											      	<div class="panel-heading">
											      		<a data-toggle="collapse" data-parent="#accordion" href="#collapse2" style="text-decoration: none;">
											        		<h4 class="panel-title" style="font-weight: bold;">Khách Hàng Mới</h4>
											        	</a>
											      	</div>
											      	<div id="collapse2" class="panel-collapse collapse">
											        	<div class="panel-body">											        		
															<div class="form-group">
															    <input type="checkbox" name="createacc" id="createacc" checked> Đặt hàng và tạo tài khoản cho tôi
															</div>

															<div class="form-group">
																<button type="submit" class="btn btn-primary" onclick="ContinueCheckout();">Tiếp tục</button>
															</div>
										...
										<div class="panel-body">
											<form name="frmOrder" id="frmOrder" action="<?php echo base_url() ?>showcart/order" method="post">
												...
												<div class="form-group">
												    ...
												    <input type="text" class="form-control" name="chfullname" id="chfullname" value="<?php echo (isset($user) && $user->us_fullname != '') ? $user->us_fullname : ''; ?>" placeholder="Nhập họ tên người nhận..." required>
												</div>

												<div class="form-group">
													<label for="chaddress"><span style="color: #c9141b; font-weight: bold;">*</span> Địa chỉ</label>
												    <input type="text" class="form-control" name="chaddress" id="chaddress" value="<?php echo (isset($user) && $user->us_address != '') ? $user->us_address : ''; ?>" placeholder="Nhập địa chỉ người nhận..." required>
												</div>

												<div class="form-group">
													<label for="chmobile"><span style="color: #c9141b; font-weight: bold;">*</span> Số điện thoại</label>
												    <input type="text" class="form-control" name="chmobile" id="chmobile" value="<?php echo (isset($user) && $user->us_mobile != '') ? $user->us_mobile : ''; ?>" placeholder="Nhập số điện thoại người nhận..." required>
												</div>

												<div class="form-group">
													<label for="chemail">Thư điện tử</label>
												    <input type="text" class="form-control" name="chemail" id="chemail" value="<?php echo (isset($user) && $user->us_email != '') ? $user->us_email : ''; ?>" placeholder="Nhập thư điện tử người nhận...">
												</div>
												...
												<div class="form-group">
													...
													<input type="hidden" name="createacc" id="createacc" value="0">
