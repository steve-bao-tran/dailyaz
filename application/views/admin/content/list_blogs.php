		        ...
		        <header>
		        	<div class="row">
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-left">
			        			<h1 class="h3 display">Danh sách blogs</h1>
			        		</div>
			        	</div>
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
		                ...
		                <div class="card-body">
		                  <div class="table-responsive">
		                    <table class="table table-striped table-hover table-custom">
		                      ...
		                      <tbody>
								<?php if(count($list_blogs) > 0) { ?>
		                        <?php foreach($list_blogs as $key => $value) { ?>
		                        <tr>
		                          <th scope="row"><?php echo $key+1; ?></th>

		                          <td><a href="/admin/edit-content/<?php echo $value->con_id; ?>" title="Sửa bài viết"><?php echo $value->con_title; ?></a>
									<p><small><strong>Người viết: </strong><i><?php echo $value->us_username; ?></i></small></p>
		                          </td>
