		        ...
		        <header>
		        	<div class="row">
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-left">
			        			<h1 class="h3 display">Danh sách tài liệu</h1>
			        		</div>
			        	</div>
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-right">
			        			<a href="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '/admin/documents'; ?>" class="btn btn-outline-success" title="Trở lại trang trước"><i class="fa fa-arrow-left"></i> Trở lại</a>			        			
			        			<a href="/admin/help-documents" class="btn btn-outline-warning" title="Giúp đỡ"><i class="fa fa-question"></i> Trợ giúp</a>
			        		</div>
			        	</div> 
		            </div>
		        </header>
		              	...
		              	<div class="card-header">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<h4><i class="fa fa-folder-open"> <a href="/admin/documents" style="text-decoration: none;" title="Về thư mục tài liệu gốc">Thư mục</a>: <?php echo $path; ?></i></h4>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div>
									...
									<div style="display:block;">
										<form name="frmUploadDoc" id="frmUploadDoc" method="post" enctype="multipart/form-data">
											<input type="file" name="uploaddoc[]" id="up_doc" accept="application/*" multiple />
											<input type="hidden" name="submitdoc" value="upload">
											<label class="btn btn-default btn-add pointer" title="Tải tài liệu lên thư mục" onclick="SubmitFrm('frmUploadDoc');" ><i class="fa fa-cloud-upload"></i> Tải tài liệu</label>
										</form>		
									</div>									
								</div>
							</div>							
								...
								<?php foreach ($list_doc as $key => $value) { ?>
									...
									<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6"  style="margin-bottom: 2%; display: block;">
							            ...
							            <div class="wrapper income text-center"><span>Thư mục</span>
							            	<a href="/admin/documents?pa=<?php echo $path; ?>&dir=<?php echo $value['name']; ?>"><img src="/templates/images/admin/icon_folder.png" alt="Thư mục" style="height: 60px; width:65px;">
									...
									<?php } else { ?>
										<?php if ($value['extens'] == 'doc' || $value['extens'] == 'docx') { ?>
											<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" style="margin-bottom: 2%; display: block;">
									            ...
									            <div class="wrapper income text-center"><span>Tập tin</span>
									            	...
									            	<img src="/templates/images/admin/icon_word.jpg" alt="<?php echo $value['name']; ?>" style="height: 60px; width:65px;"></a>
									            	<span><?php echo $value['name']; ?></span>
								             	</div>
								             	<input type="hidden" name="path_obj" value="<?php echo $value['path']; ?>">
								            </div>
										<?php } elseif ($value['extens'] == 'xls' || $value['extens'] == 'xlsx') { ?>
											<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" style="margin-bottom: 2%; display: block;">
												<div class="btn pointer" onclick="DeleteObject('<?php echo $value['path']; ?>', 0);" style="position: absolute;" title="Xóa tập tin"><img src="/templates/images/admin/icon_del.png" style="width: 70%;"></div>
									            <!-- Income-->
									            <div class="wrapper income text-center"><span>Tập tin</span>
									            	<a href="<?php echo '/'.$value['path']; ?>">
									            	<img src="/templates/images/admin/icon_ecxel.png" alt="<?php echo $value['name']; ?>" style="height: 60px; width:65px;"></a>
									            	<span><?php echo $value['name']; ?></span>
								             	</div>
								             	<input type="hidden" name="path_obj" value="<?php echo $value['path']; ?>">
								            </div>
										<?php } elseif ($value['extens'] == 'pdf') { ?>
											<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" style="margin-bottom: 2%; display: block;">
												<div class="btn pointer" onclick="DeleteObject('<?php echo $value['path']; ?>', 0);" style="position: absolute;" title="Xóa tập tin"><img src="/templates/images/admin/icon_del.png" style="width: 70%;"></div>
									            <!-- Income-->
									            <div class="wrapper income text-center"><span>Tập tin</span>
									            	<a href="<?php echo '/'.$value['path']; ?>">
									            	<img src="/templates/images/admin/icon_pdf.png" alt="<?php echo $value['name']; ?>" style="height: 60px; width:65px;"></a>
									            	<span><?php echo $value['name']; ?></span>
								             	</div>
								             	<input type="hidden" name="path_obj" value="<?php echo $value['path']; ?>">
								            </div>
										<?php } else { ?>
											<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" style="margin-bottom: 2%; display: block;">
									            ...
									            <div class="wrapper income text-center"><span>Tập tin</span>
									            	<a href="<?php echo '/'.$value['path']; ?>">
									            	<img src="/templates/images/admin/icon_doc.png" alt="<?php echo $value['name']; ?>" style="height: 60px; width:65px;"></a>
									            	<span><?php echo $value['name']; ?></span>
								             	</div>
								             	<input type="hidden" name="path_obj" value="<?php echo $value['path']; ?>">
								            </div>
