		        ...
		        <header>
		        	<div class="row">
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-left">
			        			<h1 class="h3 display">Danh sách nội dung</h1>
			        		</div>
			        	</div>
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
		                ...
		                <div class="card-body">
		                  <div class="table-responsive">
		                    <table class="table table-striped table-hover table-custom">
		                      ...
		                      <tbody>
								<?php if(count($list_content) > 0) { ?>
		                        <?php foreach($list_content as $key => $value) { ?>
		                        <tr>
		                          <th scope="row"><?php echo $key+1; ?></th>

		                          <td>
		                          	<a href="/admin/edit-content/<?php echo $value->con_id; ?>" title="Sửa bài viết"><?php echo $value->con_title; ?></a>
		                          	<span><a href="<?php echo base_url() .'tin-tuc/'. $value->con_id .'-'. RemoveSign($value->con_title); ?>" target="_blank">>> Chi tiết</a>
		                          	</span>
		                          </td>
		                          ...
		                          <td><p>
		                          	...
		                          	?>
		                          	<?php echo $type; ?> > <?php echo $value->cat_name; ?>
		                          </p></td>
