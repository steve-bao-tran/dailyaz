...
<!-- END:HEADER COMMON -->
	        ...
	        <div id="stl-content" class="col-lg-12 col-xs-12">
				...
				<div class="usercontent">
					<div class="content-header">
						<h2><span class="content-title">Sản phẩm yêu thích</span></h2>
					</div>
					<hr>
					<div class="content-body">
						...
						<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
							...
							<div class="panel panel-default info-left" style="background:#f5f5f5;border-radius: inherit;">
								<ul class="list-unstyled">
									...
									<li class="li5 li-active"><a href="<?php echo base_url() ?>tai-khoan/san-pham-thich"><i class="fa fa-thumbs-o-up"></i>  Sản phẩm yêu thích </a><i class="fa fa-angle-double-right pull-right"></i></li>
						...
						<div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
							...
							<div class="panel panel-default info-right" style="border-radius: inherit;">
								<div class="panel-heading"><span class="title-uppercase">Sản phẩm yêu thích</span><span class="pull-right total-like" style="font-size: 15px;"></span></div>
								<div class="panel-body">									
									<div class="productFavList">
										<?php if ($pro_favo) { ?>
											<?php foreach ($pro_favo as $key => $value) { $key++; ?>
												...
												<div class="item row">
											        ...
											        <div class="col-sm-4 r-button">	
										            	<a href="<?php echo base_url() .'tai-khoan/xoa-san-pham-thich/'. $value->pro_id ?>" class="remove"></a>
											...
											<?php } ?>
										<?php } else { ?>
											<p class="text-center">Chưa có sản phẩm yêu thích nào trong danh sách yêu thích của bạn!!</p>
										<?php } ?>
	...
	<script>
		$(document).ready(function($) {
			var tolike = 'Tổng: '+<?php echo $key ? $key : 0; ?>+' sản phẩm yêu thích';
			$('.total-like').html(tolike);
		});
	</script>
