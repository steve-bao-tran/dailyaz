		        ...
		        <header>
		        	<div class="row">
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-left">
			        			<h1 class="h3 display">Danh sách âm nhạc</h1>
			        		</div>
			        	</div>
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-right">
			        			<a href="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '/admin/musics'; ?>" class="btn btn-outline-success" title="Trở lại trang trước"><i class="fa fa-arrow-left"></i> Trở lại</a>			        			
			        			<a href="/admin/help-musics" class="btn btn-outline-warning" title="Giúp đỡ"><i class="fa fa-question"></i> Trợ giúp</a>
			        		</div>
			        	</div> 
		            </div>
		        </header>
		              ...
		              <div class="card">
		              	...
		              	<div class="card-header">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<h4><i class="fa fa-folder-open"> <a href="/admin/musics" style="text-decoration: none;" title="Về thư mục nhạc gốc">Thư mục</a>: <?php echo $path; ?></i></h4>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div>
									...
									<div style="display:block;">
										<form name="frmUploadMusic" id="frmUploadMusic" method="post" enctype="multipart/form-data">
											<input type="file" name="uploadmusic[]" id="up_music" accept="audio/*" multiple />
											<input type="hidden" name="submitmusic" value="upload">
											<label class="btn btn-default btn-add pointer" title="Tải nhạc lên thư mục" onclick="SubmitFrm('frmUploadMusic');" ><i class="fa fa-cloud-upload"></i> Tải nhạc</label>
										</form>		
									</div>									
								</div>
							</div>							
		                ...
		                <div class="card-body">				
							...
							<div class="row d-flex align-items-stretch">
								...
								<?php foreach ($list_music as $key => $value) { ?>
									...
									<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6"  style="margin-bottom: 2%; display: block;">
							            ...
							            <div class="wrapper income text-center"><span>Thư mục</span>
							            	<a href="/admin/musics?pa=<?php echo $path; ?>&dir=<?php echo $value['name']; ?>"><img src="/templates/images/admin/icon_folder.png" alt="Thư mục" style="height: 60px; width: 65px;">
						            ...
						            <?php } else { ?>
									<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" style="margin-bottom: 2%; display: block;">
										<div class="btn pointer" onclick="DeleteObject('<?php echo $value['path']; ?>', 0);" style="position: absolute;" title="Xóa nhạc"><img src="/templates/images/admin/icon_del.png" style="width: 70%;"></div>
							            <!-- Income-->
							            <div class="wrapper income text-center"><span>Nhạc</span>
							            	<a href="<?php echo '/'.$value['path']; ?>">
							            	<img src="/templates/images/admin/icon_music.png" alt="<?php echo $value['name']; ?>" style="height: 60px; width: 65px;"></a>
							            	<span><?php echo $value['name']; ?></span>
						             	</div>
						             	<input type="hidden" name="path_obj" value="<?php echo $value['path']; ?>">
						            </div>
