		        ...
		        <header>
		        	<div class="row">
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-left">
			        			<h1 class="h3 display">Danh sách phim</h1>
			        		</div>
			        	</div>
			        	<div class="col-sx-12 col-sm-12 col-md-6 col-lg-6">
			        		<div class="pull-right">
			        			<a href="<?php echo isset($_SERVER['HTTP_REFERER']) ? $_SERVER['HTTP_REFERER'] : '/admin/videos'; ?>" class="btn btn-outline-success" title="Trở lại trang trước"><i class="fa fa-arrow-left"></i> Trở lại</a>			        			
			        			<a href="/admin/help-videos" class="btn btn-outline-warning" title="Giúp đỡ"><i class="fa fa-question"></i> Trợ giúp</a>
			        		</div>
			        	</div> 
		            </div>
		        </header>
		              	...
		              	<div class="card-header">
							<div class="row">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<h4><i class="fa fa-folder-open"> <a href="/admin/videos" style="text-decoration: none;" title="Về thư mục phim gốc">Thư mục</a>: <?php echo $path; ?></i></h4>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<div>
									...
									<div style="display:block;">
										<form name="frmUploadVideo" id="frmUploadVideo" method="post" enctype="multipart/form-data">
											<input type="file" name="uploadvideo[]" id="up_video" accept="video/*" multiple />
											<input type="hidden" name="submitvideo" value="upload">
											<label class="btn btn-default btn-add pointer" title="Tải video lên thư mục" onclick="SubmitFrm('frmUploadVideo');" ><i class="fa fa-cloud-upload"></i> Tải video</label>
										</form>		
									</div>									
								</div>
							</div>							
								...
								<?php foreach ($list_video as $key => $value) { ?>
									...
									<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6"  style="margin-bottom: 2%; display: block;">
							            ...
							            <div class="wrapper income text-center"><span>Thư mục</span>
							            	<a href="/admin/videos?pa=<?php echo $path; ?>&dir=<?php echo $value['name']; ?>"><img src="/templates/images/admin/icon_folder.png" alt="Thư mục" style="height: 60px; width: 65px;">
						            ...
						            <?php } else { ?>
									<div class="col-lg-2 col-md-2 col-sm-4 col-xs-6" style="margin-bottom: 2%; display: block;">
										<div class="btn pointer" onclick="DeleteObject('<?php echo $value['path']; ?>', 0);" style="position: absolute;" title="Xóa video"><img src="/templates/images/admin/icon_del.png" style="width: 70%;"></div>
							            <!-- Income-->
							            <div class="wrapper income text-center"><span>Video</span>
							            	<a href="<?php echo '/'.$value['path']; ?>">
							            	<img src="/templates/images/admin/icon_video.png" alt="<?php echo $value['name']; ?>" style="height: 60px; width: 65px;"></a>
							            	<span><?php echo $value['name']; ?></span>
						             	</div>
						             	<input type="hidden" name="path_obj" value="<?php echo $value['path']; ?>">
						            </div>
