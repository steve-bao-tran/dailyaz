...
class CI_Captcha
{
    function create($str, $pathImage = 'templates/images/bg_captcha.jpg', $fontSize = 28, $fontName = 'templates/font/ChaparralPro-BoldIt.otf', $background = 'templates/images/bg_captcha.jpg')
	{
	...
	function code($length = 6, $mode = '3')
	{
		...
		return preg_replace("/[^A-Za-z0-9_]/","",(string)$codeCreated);
	}
}