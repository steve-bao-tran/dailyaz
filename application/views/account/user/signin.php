	        ...
	        <div id="stl-content" class="col-lg-9 col-sm-8 col-xs-12">
				...
				<div class="usercontent">
					<div class="content-header">
						<h2><span class="content-title">Đăng nhập</span></h2>
					</div>
					<hr>
							...
							<div class="panel panel-default">
								<div class="panel-body">
									<form name="frmSignin" id="frmSignin" method="post">
										...
										<div class="form-group">
											<button type="submit" class="btn btn btn-primary">Đăng nhập</button><span class="pull-right"><h6><a href="<?php echo base_url() ?>tai-khoan/quen-mat-khau">Quên mật khẩu?</a></h6></span>
										</div>
